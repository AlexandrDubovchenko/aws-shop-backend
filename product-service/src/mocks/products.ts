import { Product } from "src/services/products/types";
...
export const productsListMock: Product[] = [
  ...
  },
  {
    ...
    price: 279,
    currency: '$',
    image: 'https://i.allo.ua/media/catalog/product/cache/3/image/710x600/602f0fa2c1f0d1ba5e241f914e856ff9/0/_/0_59_12_2.jpg'
  },
  {
    id: 5,
    name: 'OnePlus 9 Pro',
  ...
  },
  {
    ...
    image: 'https://specs-tech.com/wp-content/uploads/2021/10/Samsung-Galaxy-Z-Flip-4-2.jpg',
    price: 999,
    currency: '$'
  },
  {
    ...
    price: 888,
    currency: '$',
    image: 'https://dlcdnwebimgs.asus.com/gain/cf4f48f6-b62f-4a29-aa0e-623a24d9b532/'
  }
]